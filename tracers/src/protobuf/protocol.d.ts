...
export class Tracers extends $protobuf.rpc.Service {
     ...
     */
    public languages(request: Empty, callback: Tracers.languagesCallback): void;
     ...
     * @returns Promise
     */
    public languages(request: Empty): Promise<Languages>;

    /**
     * Calls trace.
     * @param request TraceRequest message or plain object
     * @param callback Node-style callback called with the error, if any, and Result
     */
    public trace(request: TraceRequest, callback: Tracers.traceCallback): void;
     ...
     * @returns Promise
     */
    public trace(request: TraceRequest): Promise<Result>;
}
...
export namespace Tracers {
     ...
     */
    type languagesCallback = (error: (Error|null), response?: Languages) => void;
     ...
     */
    type traceCallback = (error: (Error|null), response?: Result) => void;
}
...
/** Represents a TraceRequest. */
export class TraceRequest implements ITraceRequest {

    /**
     * Constructs a new TraceRequest.
     * @param [properties] Properties to set
     */
    constructor(properties?: ITraceRequest);
     ...
     * @param [properties] Properties to set
     * @returns TraceRequest instance
     */
    public static create(properties?: ITraceRequest): TraceRequest;

    /**
     * Encodes the specified TraceRequest message. Does not implicitly {@link TraceRequest.verify|verify} messages.
     * @param message TraceRequest message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: TraceRequest, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: TraceRequest, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): TraceRequest;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): TraceRequest;
     ...
     * @returns TraceRequest
     */
    public static fromObject(object: { [k: string]: any }): TraceRequest;

    /**
     * Creates a plain object from a TraceRequest message. Also converts values to other types if specified.
     * @param message TraceRequest
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: TraceRequest, options?: $protobuf.IConversionOptions): { [k: string]: any };
