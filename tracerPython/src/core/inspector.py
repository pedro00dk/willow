...
class Inspector:
    """
    Controls the script tracing progression by receiving commands.
    """
    ...
    def __init__(self, name: str, lines: list, action_queue: mp.Queue, result_queue: mp.Queue):
        """
        Initializes the tracer controller with the script name and lines.
        """
        self._name = name
        self._lines = lines
    ...
    def is_script_file(self, frame: types.FrameType):
        """
        Returns true if the frame is from the main script file.
        """
